...
export type AdOfferQuestion = {
  __typename?: 'AdOfferQuestion';
  batch: Scalars['ID'];
  id: Scalars['ID'];
...
export type AdServed = {
  ...
  creative: Creative;
  flightID: Scalars['ID'];
  inheritedClaim?: Maybe<InheritedClaimForAd>;
  offerID: Scalars['ID'];
...
export enum AdvertiserVisibility {
  Private = 'Private',
  Public = 'Public'
}
...
export enum AffiliateVisibility {
  Private = 'Private',
  Public = 'Public'
}

export type AfterTicketClaimQuestionInput = {
  answer: Scalars['String'];
  questionID: Scalars['ID'];
};

export type AfterTicketClaimQuestionPayload = {
  adSetID: Scalars['ID'];
  answers: Array<AfterTicketClaimQuestionInput>;
  claimID?: InputMaybe<Scalars['ID']>;
  flightID?: InputMaybe<Scalars['ID']>;
  referralID: Scalars['ID'];
};

export type AfterTicketClaimQuestionResponse = AfterTicketClaimQuestionResponseSuccess | ResponseError;

export type AfterTicketClaimQuestionResponseSuccess = {
  __typename?: 'AfterTicketClaimQuestionResponseSuccess';
...
export type BulkCreateLootboxBodyPayload = {
...
export type BulkCreateLootboxPayload = {
  lootboxes: Array<BulkCreateLootboxBodyPayload>;
};

export type BulkCreateLootboxResponse = BulkCreateLootboxResponseSuccess | ResponseError;

export type BulkCreateLootboxResponseSuccess = {
  __typename?: 'BulkCreateLootboxResponseSuccess';
  lootboxes: Array<Lootbox>;
  partialErrors?: Maybe<Array<BulkLootboxCreatedPartialError>>;
};
...
export type BulkLootboxCreatedPartialError = {
  __typename?: 'BulkLootboxCreatedPartialError';
...
export type Claim = {
  ...
  privacyScope: Array<TournamentPrivacyScope>;
  promoterId?: Maybe<Scalars['ID']>;
...
export type ClaimerCsvDataPayload = {
  eventID: Scalars['ID'];
};

export type ClaimerCsvDataResponse = ClaimerCsvDataResponseSuccess | ResponseError;

export type ClaimerCsvDataResponseSuccess = {
  __typename?: 'ClaimerCSVDataResponseSuccess';
  csvDownloadURL: Scalars['String'];
};
...
export type CreateOfferPayload = {
  ...
  afterTicketClaimMetadata?: InputMaybe<OfferAfterTicketClaimMetadataCreateInput>;
...
export type DecisionAdAirdropV1Payload = {
  lootboxID: Scalars['ID'];
  placement: Placement;
  sessionID: Scalars['ID'];
};

export type DecisionAdAirdropV1Response = DecisionAdAirdropV1ResponseSuccess | ResponseError;

export type DecisionAdAirdropV1ResponseSuccess = {
  __typename?: 'DecisionAdAirdropV1ResponseSuccess';
  ad?: Maybe<AdServed>;
  errorMessage?: Maybe<Scalars['String']>;
  questions: Array<AdOfferQuestion>;
  requiresAd: Scalars['Boolean'];
};
...
export type DecisionAdApiBetaV2ResponseSuccess = {
  ...
  ad?: Maybe<AdServed>;
  questions?: Maybe<Array<AdOfferQuestion>>;
};
...
export type DepositVoucherRewardsPayload = {
  lootboxID: Scalars['ID'];
  offerID?: InputMaybe<Scalars['ID']>;
  oneTimeVouchers?: InputMaybe<Scalars['String']>;
  reuseableVoucher?: InputMaybe<Scalars['String']>;
  title: Scalars['String'];
};

export type DepositVoucherRewardsResponse = DepositVoucherRewardsResponseSuccess | ResponseError;

export type DepositVoucherRewardsResponseSuccess = {
  __typename?: 'DepositVoucherRewardsResponseSuccess';
...
export type EditOfferPayload = {
  advertiserID: Scalars['ID'];
  afterTicketClaimMetadata?: InputMaybe<OfferAfterTicketClaimMetadataEditInput>;
  ...
  status: OfferStatus;
  title?: InputMaybe<Scalars['String']>;
  visibility?: InputMaybe<OfferVisibility>;
};
...
export type FanListRowForLootbox = {
  __typename?: 'FanListRowForLootbox';
  avatar: Scalars['String'];
  claimsCount: Scalars['Int'];
  expiredClaimsCount: Scalars['Int'];
...
export type FansListForLootboxResponse = FansListForLootboxResponseSuccess | ResponseError;

export type FansListForLootboxResponseSuccess = {
  __typename?: 'FansListForLootboxResponseSuccess';
  fans: Array<FanListRowForLootbox>;
  lootboxID: Scalars['ID'];
};
...
export type GetLootboxDepositsResponse = GetLootboxDepositsResponseSuccess | ResponseError;

export type GetLootboxDepositsResponseSuccess = {
  __typename?: 'GetLootboxDepositsResponseSuccess';
  deposits: Array<LootboxVoucherDeposits>;
};
...
export type GetVoucherOfDepositForFanPayload = {
  depositID: Scalars['ID'];
  ticketID: Scalars['ID'];
};

export type GetVoucherOfDepositForFanResponse = GetVoucherOfDepositForFanResponseSuccess | ResponseError;

export type GetVoucherOfDepositForFanResponseSuccess = {
  __typename?: 'GetVoucherOfDepositForFanResponseSuccess';
  voucher: VoucherDeposit;
};

export type InheritedClaimForAd = {
  __typename?: 'InheritedClaimForAd';
  claimID?: Maybe<Scalars['ID']>;
  promoterID?: Maybe<Scalars['ID']>;
  referrerID?: Maybe<Scalars['ID']>;
  tournamentID?: Maybe<Scalars['ID']>;
...
export type ListAvailableLootboxesForClaimResponseSuccess = {
  ...
  termsOfService: Array<TournamentPrivacyScope>;
};
...
export type LootboxSafetyFeatures = {
  __typename?: 'LootboxSafetyFeatures';
  isExclusiveLootbox?: Maybe<Scalars['Boolean']>;
...
export type LootboxTicket = {
  ...
  createdAt: Scalars['Timestamp'];
  digest?: Maybe<Scalars['ID']>;
  id: Scalars['ID'];
  isMinted: Scalars['Boolean'];
  lootboxAddress?: Maybe<Scalars['ID']>;
  lootboxID: Scalars['ID'];
  metadataURL?: Maybe<Scalars['String']>;
  mintWhitelistID?: Maybe<Scalars['ID']>;
  mintedAt?: Maybe<Scalars['Timestamp']>;
  minterAddress?: Maybe<Scalars['ID']>;
  minterUserID?: Maybe<Scalars['ID']>;
  nonce?: Maybe<Scalars['ID']>;
  ownerUserID?: Maybe<Scalars['ID']>;
...
export type LootboxVoucherDeposits = {
  __typename?: 'LootboxVoucherDeposits';
  createdAt: Scalars['Timestamp'];
  hasReuseableVoucher: Scalars['Boolean'];
  id: Scalars['ID'];
  isRedeemed?: Maybe<Scalars['Boolean']>;
  oneTimeVouchersCount: Scalars['Int'];
  title: Scalars['String'];
};
...
export type Mutation = {
  ...
  answerAfterTicketClaimQuestion: AfterTicketClaimQuestionResponse;
  answerAirdropQuestion: AnswerAirdropQuestionResponse;
  authenticateWallet: AuthenticateWalletResponse;
  bulkCreateLootbox: BulkCreateLootboxResponse;
  ...
  claimerCSVData: ClaimerCsvDataResponse;
  ...
  depositVoucherRewards: DepositVoucherRewardsResponse;
  ...
  offerClaimsCSV: OfferClaimsCsvResponse;
  offerEventClaimsCSV: OfferEventClaimsCsvResponse;
...
export type MutationAnswerAfterTicketClaimQuestionArgs = {
...
export type MutationBulkCreateLootboxArgs = {
...
export type MutationClaimerCsvDataArgs = {
  payload: ClaimerCsvDataPayload;
};
...
export type MutationDepositVoucherRewardsArgs = {
...
export type MutationOfferClaimsCsvArgs = {
  payload: OfferClaimsCsvPayload;
};


export type MutationOfferEventClaimsCsvArgs = {
...
export type Offer = {
  ...
  afterTicketClaimMetadata?: Maybe<OfferAfterTicketClaimMetadata>;
...
export type OfferActivationsForEventPayload = {
  eventID: Scalars['ID'];
  offerID: Scalars['ID'];
};

export type OfferActivationsForEventResponse = OfferActivationsForEventResponseSuccess | ResponseError;

export type OfferActivationsForEventResponseSuccess = {
  __typename?: 'OfferActivationsForEventResponseSuccess';
  data: Array<OfferActivationsForEventRow>;
};

export type OfferActivationsForEventRow = {
  __typename?: 'OfferActivationsForEventRow';
  activationDescription: Scalars['String'];
  activationID: Scalars['String'];
  activationName: Scalars['String'];
  adEventCount: Scalars['Int'];
};

export type OfferActivationsPayload = {
  offerID: Scalars['ID'];
};

export type OfferActivationsResponse = OfferActivationsResponseSuccess | ResponseError;

export type OfferActivationsResponseSuccess = {
  __typename?: 'OfferActivationsResponseSuccess';
  data: Array<OfferActivationsRow>;
};

export type OfferActivationsRow = {
  __typename?: 'OfferActivationsRow';
  activationDescription: Scalars['String'];
  activationID: Scalars['String'];
  activationName: Scalars['String'];
  adEventCount: Scalars['Int'];
...
export type OfferAfterTicketClaimMetadata = {
  __typename?: 'OfferAfterTicketClaimMetadata';
  questions: Array<QuestionAnswerPreview>;
};

export type OfferAfterTicketClaimMetadataCreateInput = {
  questions: Array<QuestionCreateInput>;
};

export type OfferAfterTicketClaimMetadataEditInput = {
  questions?: InputMaybe<Array<QuestionCreateInput>>;
};
...
export type OfferClaimsCsvPayload = {
  offerID: Scalars['ID'];
};

export type OfferClaimsCsvResponse = OfferClaimsCsvResponseSuccess | ResponseError;

export type OfferClaimsCsvResponseSuccess = {
  __typename?: 'OfferClaimsCSVResponseSuccess';
  csvDownloadURL: Scalars['String'];
};

export type OfferEventClaimsCsvPayload = {
  eventID: Scalars['ID'];
  offerID: Scalars['ID'];
};

export type OfferEventClaimsCsvResponse = OfferEventClaimsCsvResponseSuccess | ResponseError;

export type OfferEventClaimsCsvResponseSuccess = {
...
export type Query = {
  ...
  getLootboxDeposits: GetLootboxDepositsResponse;
  getMyProfile: GetMyProfileResponse;
  getVoucherOfDepositForFan: GetVoucherOfDepositForFanResponse;
  ...
  offerActivations: OfferActivationsResponse;
  offerActivationsForEvent: OfferActivationsForEventResponse;
...
export type QueryDecisionAdAirdropV1Args = {
...
export type QueryFansListForLootboxArgs = {
  lootboxID: Scalars['ID'];
};
...
export type QueryGetLootboxDepositsArgs = {
  lootboxID: Scalars['ID'];
};


export type QueryGetVoucherOfDepositForFanArgs = {
...
export type QueryOfferActivationsArgs = {
  payload: OfferActivationsPayload;
};


export type QueryOfferActivationsForEventArgs = {
...
export type Tournament = {
  ...
  playbookUrl?: Maybe<Scalars['String']>;
  privacyScope?: Maybe<Array<TournamentPrivacyScope>>;
  prize?: Maybe<Scalars['String']>;
...
export type TournamentSafetyFeatures = {
  __typename?: 'TournamentSafetyFeatures';
  maxTicketsPerUser?: Maybe<Scalars['Int']>;
  seedMaxLootboxTicketsPerUser?: Maybe<Scalars['Int']>;
};
...
export type UpdateAdvertiserDetailsPayload = {
  ...
  visibility?: InputMaybe<AdvertiserVisibility>;
...
export type UpdateAffiliateDetailsPayload = {
  ...
  name: Scalars['String'];
  publicContactEmail?: InputMaybe<Scalars['String']>;
  visibility?: InputMaybe<AffiliateVisibility>;
  website?: InputMaybe<Scalars['String']>;
};
...
export type VoucherDeposit = {
  __typename?: 'VoucherDeposit';
...
export type ResolversTypes = {
  ...
  AdOfferQuestion: ResolverTypeWrapper<AdOfferQuestion>;
  ...
  AdvertiserVisibility: AdvertiserVisibility;
  ...
  AffiliateType: AffiliateType;
  AffiliateVisibility: AffiliateVisibility;
  AfterTicketClaimQuestionInput: AfterTicketClaimQuestionInput;
  AfterTicketClaimQuestionPayload: AfterTicketClaimQuestionPayload;
  AfterTicketClaimQuestionResponse: ResolversTypes['AfterTicketClaimQuestionResponseSuccess'] | ResolversTypes['ResponseError'];
  AfterTicketClaimQuestionResponseSuccess: ResolverTypeWrapper<AfterTicketClaimQuestionResponseSuccess>;
  ...
  BulkCreateLootboxBodyPayload: BulkCreateLootboxBodyPayload;
  BulkCreateLootboxPayload: BulkCreateLootboxPayload;
  BulkCreateLootboxResponse: ResolversTypes['BulkCreateLootboxResponseSuccess'] | ResolversTypes['ResponseError'];
  BulkCreateLootboxResponseSuccess: ResolverTypeWrapper<BulkCreateLootboxResponseSuccess>;
  ...
  BulkLootboxCreatedPartialError: ResolverTypeWrapper<BulkLootboxCreatedPartialError>;
  ...
  ClaimType: ClaimType;
  ClaimerCSVDataPayload: ClaimerCsvDataPayload;
  ClaimerCSVDataResponse: ResolversTypes['ClaimerCSVDataResponseSuccess'] | ResolversTypes['ResponseError'];
  ClaimerCSVDataResponseSuccess: ResolverTypeWrapper<ClaimerCsvDataResponseSuccess>;
  ...
  DecisionAdAirdropV1Payload: DecisionAdAirdropV1Payload;
  DecisionAdAirdropV1Response: ResolversTypes['DecisionAdAirdropV1ResponseSuccess'] | ResolversTypes['ResponseError'];
  DecisionAdAirdropV1ResponseSuccess: ResolverTypeWrapper<DecisionAdAirdropV1ResponseSuccess>;
  ...
  DepositVoucherRewardsPayload: DepositVoucherRewardsPayload;
  DepositVoucherRewardsResponse: ResolversTypes['DepositVoucherRewardsResponseSuccess'] | ResolversTypes['ResponseError'];
  DepositVoucherRewardsResponseSuccess: ResolverTypeWrapper<DepositVoucherRewardsResponseSuccess>;
  ...
  FansListForLootboxResponse: ResolversTypes['FansListForLootboxResponseSuccess'] | ResolversTypes['ResponseError'];
  FansListForLootboxResponseSuccess: ResolverTypeWrapper<FansListForLootboxResponseSuccess>;
  ...
  GetLootboxDepositsResponse: ResolversTypes['GetLootboxDepositsResponseSuccess'] | ResolversTypes['ResponseError'];
  GetLootboxDepositsResponseSuccess: ResolverTypeWrapper<GetLootboxDepositsResponseSuccess>;
  ...
  GetVoucherOfDepositForFanPayload: GetVoucherOfDepositForFanPayload;
  GetVoucherOfDepositForFanResponse: ResolversTypes['GetVoucherOfDepositForFanResponseSuccess'] | ResolversTypes['ResponseError'];
  GetVoucherOfDepositForFanResponseSuccess: ResolverTypeWrapper<GetVoucherOfDepositForFanResponseSuccess>;
  ...
  LootboxSafetyFeatures: ResolverTypeWrapper<LootboxSafetyFeatures>;
  ...
  LootboxVoucherDeposits: ResolverTypeWrapper<LootboxVoucherDeposits>;
  ...
  OfferActivationsForEventPayload: OfferActivationsForEventPayload;
  OfferActivationsForEventResponse: ResolversTypes['OfferActivationsForEventResponseSuccess'] | ResolversTypes['ResponseError'];
  OfferActivationsForEventResponseSuccess: ResolverTypeWrapper<OfferActivationsForEventResponseSuccess>;
  OfferActivationsForEventRow: ResolverTypeWrapper<OfferActivationsForEventRow>;
  OfferActivationsPayload: OfferActivationsPayload;
  OfferActivationsResponse: ResolversTypes['OfferActivationsResponseSuccess'] | ResolversTypes['ResponseError'];
  OfferActivationsResponseSuccess: ResolverTypeWrapper<OfferActivationsResponseSuccess>;
  OfferActivationsRow: ResolverTypeWrapper<OfferActivationsRow>;
  OfferAffiliateView: ResolverTypeWrapper<OfferAffiliateView>;
  OfferAfterTicketClaimMetadata: ResolverTypeWrapper<OfferAfterTicketClaimMetadata>;
  OfferAfterTicketClaimMetadataCreateInput: OfferAfterTicketClaimMetadataCreateInput;
  OfferAfterTicketClaimMetadataEditInput: OfferAfterTicketClaimMetadataEditInput;
  ...
  OfferClaimsCSVPayload: OfferClaimsCsvPayload;
  OfferClaimsCSVResponse: ResolversTypes['OfferClaimsCSVResponseSuccess'] | ResolversTypes['ResponseError'];
  OfferClaimsCSVResponseSuccess: ResolverTypeWrapper<OfferClaimsCsvResponseSuccess>;
  OfferEventClaimsCSVPayload: OfferEventClaimsCsvPayload;
  OfferEventClaimsCSVResponse: ResolversTypes['OfferEventClaimsCSVResponseSuccess'] | ResolversTypes['ResponseError'];
  OfferEventClaimsCSVResponseSuccess: ResolverTypeWrapper<OfferEventClaimsCsvResponseSuccess>;
  ...
  TournamentPrivacyScope: TournamentPrivacyScope;
  ...
  TournamentSafetyFeatures: ResolverTypeWrapper<TournamentSafetyFeatures>;
  ...
  VoucherDeposit: ResolverTypeWrapper<VoucherDeposit>;
...
export type ResolversParentTypes = {
  ...
  AdOfferQuestion: AdOfferQuestion;
  ...
  AfterTicketClaimQuestionInput: AfterTicketClaimQuestionInput;
  AfterTicketClaimQuestionPayload: AfterTicketClaimQuestionPayload;
  AfterTicketClaimQuestionResponse: ResolversParentTypes['AfterTicketClaimQuestionResponseSuccess'] | ResolversParentTypes['ResponseError'];
  AfterTicketClaimQuestionResponseSuccess: AfterTicketClaimQuestionResponseSuccess;
  AirdropMetadataCreateInput: AirdropMetadataCreateInput;
  ...
  BulkCreateLootboxBodyPayload: BulkCreateLootboxBodyPayload;
  BulkCreateLootboxPayload: BulkCreateLootboxPayload;
  BulkCreateLootboxResponse: ResolversParentTypes['BulkCreateLootboxResponseSuccess'] | ResolversParentTypes['ResponseError'];
  BulkCreateLootboxResponseSuccess: BulkCreateLootboxResponseSuccess;
  BulkCreateReferralPayload: BulkCreateReferralPayload;
  ...
  BulkLootboxCreatedPartialError: BulkLootboxCreatedPartialError;
  ...
  ClaimerCSVDataPayload: ClaimerCsvDataPayload;
  ClaimerCSVDataResponse: ResolversParentTypes['ClaimerCSVDataResponseSuccess'] | ResolversParentTypes['ResponseError'];
  ClaimerCSVDataResponseSuccess: ClaimerCsvDataResponseSuccess;
  ...
  DecisionAdAirdropV1Payload: DecisionAdAirdropV1Payload;
  DecisionAdAirdropV1Response: ResolversParentTypes['DecisionAdAirdropV1ResponseSuccess'] | ResolversParentTypes['ResponseError'];
  DecisionAdAirdropV1ResponseSuccess: DecisionAdAirdropV1ResponseSuccess;
  DecisionAdApiBetaV2Payload: DecisionAdApiBetaV2Payload;
  ...
  DepositVoucherRewardsPayload: DepositVoucherRewardsPayload;
  DepositVoucherRewardsResponse: ResolversParentTypes['DepositVoucherRewardsResponseSuccess'] | ResolversParentTypes['ResponseError'];
  DepositVoucherRewardsResponseSuccess: DepositVoucherRewardsResponseSuccess;
  ...
  FansListForLootboxResponse: ResolversParentTypes['FansListForLootboxResponseSuccess'] | ResolversParentTypes['ResponseError'];
  FansListForLootboxResponseSuccess: FansListForLootboxResponseSuccess;
  ...
  GetLootboxDepositsResponse: ResolversParentTypes['GetLootboxDepositsResponseSuccess'] | ResolversParentTypes['ResponseError'];
  GetLootboxDepositsResponseSuccess: GetLootboxDepositsResponseSuccess;
  ...
  GetVoucherOfDepositForFanPayload: GetVoucherOfDepositForFanPayload;
  GetVoucherOfDepositForFanResponse: ResolversParentTypes['GetVoucherOfDepositForFanResponseSuccess'] | ResolversParentTypes['ResponseError'];
  GetVoucherOfDepositForFanResponseSuccess: GetVoucherOfDepositForFanResponseSuccess;
  HSL: Scalars['HSL'];
  HSLA: Scalars['HSLA'];
  ...
  LootboxSafetyFeatures: LootboxSafetyFeatures;
  ...
  LootboxVoucherDeposits: LootboxVoucherDeposits;
  MAC: Scalars['MAC'];
  ...
  Offer: Offer;
  OfferActivationsForEventPayload: OfferActivationsForEventPayload;
  OfferActivationsForEventResponse: ResolversParentTypes['OfferActivationsForEventResponseSuccess'] | ResolversParentTypes['ResponseError'];
  OfferActivationsForEventResponseSuccess: OfferActivationsForEventResponseSuccess;
  OfferActivationsForEventRow: OfferActivationsForEventRow;
  OfferActivationsPayload: OfferActivationsPayload;
  OfferActivationsResponse: ResolversParentTypes['OfferActivationsResponseSuccess'] | ResolversParentTypes['ResponseError'];
  OfferActivationsResponseSuccess: OfferActivationsResponseSuccess;
  OfferActivationsRow: OfferActivationsRow;
  OfferAffiliateView: OfferAffiliateView;
  OfferAfterTicketClaimMetadata: OfferAfterTicketClaimMetadata;
  OfferAfterTicketClaimMetadataCreateInput: OfferAfterTicketClaimMetadataCreateInput;
  OfferAfterTicketClaimMetadataEditInput: OfferAfterTicketClaimMetadataEditInput;
  ...
  OfferClaimsCSVPayload: OfferClaimsCsvPayload;
  OfferClaimsCSVResponse: ResolversParentTypes['OfferClaimsCSVResponseSuccess'] | ResolversParentTypes['ResponseError'];
  OfferClaimsCSVResponseSuccess: OfferClaimsCsvResponseSuccess;
  OfferEventClaimsCSVPayload: OfferEventClaimsCsvPayload;
  OfferEventClaimsCSVResponse: ResolversParentTypes['OfferEventClaimsCSVResponseSuccess'] | ResolversParentTypes['ResponseError'];
  OfferEventClaimsCSVResponseSuccess: OfferEventClaimsCsvResponseSuccess;
  ...
  TournamentSafetyFeatures: TournamentSafetyFeatures;
...
export type AdOfferQuestionResolvers<ContextType = any, ParentType extends ResolversParentTypes['AdOfferQuestion'] = ResolversParentTypes['AdOfferQuestion']> = {
...
export type AdServedResolvers<ContextType = any, ParentType extends ResolversParentTypes['AdServed'] = ResolversParentTypes['AdServed']> = {
  ...
  inheritedClaim?: Resolver<Maybe<ResolversTypes['InheritedClaimForAd']>, ParentType, ContextType>;
  offerID?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type AdvertiserResolvers<ContextType = any, ParentType extends ResolversParentTypes['Advertiser'] = ResolversParentTypes['Advertiser']> = {
  ...
  visibility?: Resolver<ResolversTypes['AdvertiserVisibility'], ParentType, ContextType>;
...
export type AffiliateResolvers<ContextType = any, ParentType extends ResolversParentTypes['Affiliate'] = ResolversParentTypes['Affiliate']> = {
  ...
  userID?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  visibility?: Resolver<ResolversTypes['AffiliateVisibility'], ParentType, ContextType>;
  website?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type AfterTicketClaimQuestionResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['AfterTicketClaimQuestionResponse'] = ResolversParentTypes['AfterTicketClaimQuestionResponse']> = {
  __resolveType: TypeResolveFn<'AfterTicketClaimQuestionResponseSuccess' | 'ResponseError', ParentType, ContextType>;
};

export type AfterTicketClaimQuestionResponseSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['AfterTicketClaimQuestionResponseSuccess'] = ResolversParentTypes['AfterTicketClaimQuestionResponseSuccess']> = {
...
export type BulkCreateLootboxResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['BulkCreateLootboxResponse'] = ResolversParentTypes['BulkCreateLootboxResponse']> = {
  __resolveType: TypeResolveFn<'BulkCreateLootboxResponseSuccess' | 'ResponseError', ParentType, ContextType>;
};

export type BulkCreateLootboxResponseSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['BulkCreateLootboxResponseSuccess'] = ResolversParentTypes['BulkCreateLootboxResponseSuccess']> = {
  lootboxes?: Resolver<Array<ResolversTypes['Lootbox']>, ParentType, ContextType>;
  partialErrors?: Resolver<Maybe<Array<ResolversTypes['BulkLootboxCreatedPartialError']>>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type BulkLootboxCreatedPartialErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['BulkLootboxCreatedPartialError'] = ResolversParentTypes['BulkLootboxCreatedPartialError']> = {
...
export type ClaimResolvers<ContextType = any, ParentType extends ResolversParentTypes['Claim'] = ResolversParentTypes['Claim']> = {
  ...
  privacyScope?: Resolver<Array<ResolversTypes['TournamentPrivacyScope']>, ParentType, ContextType>;
  promoterId?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
...
export type ClaimerCsvDataResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['ClaimerCSVDataResponse'] = ResolversParentTypes['ClaimerCSVDataResponse']> = {
  __resolveType: TypeResolveFn<'ClaimerCSVDataResponseSuccess' | 'ResponseError', ParentType, ContextType>;
};

export type ClaimerCsvDataResponseSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['ClaimerCSVDataResponseSuccess'] = ResolversParentTypes['ClaimerCSVDataResponseSuccess']> = {
  csvDownloadURL?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type DecisionAdAirdropV1ResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['DecisionAdAirdropV1Response'] = ResolversParentTypes['DecisionAdAirdropV1Response']> = {
  __resolveType: TypeResolveFn<'DecisionAdAirdropV1ResponseSuccess' | 'ResponseError', ParentType, ContextType>;
};

export type DecisionAdAirdropV1ResponseSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['DecisionAdAirdropV1ResponseSuccess'] = ResolversParentTypes['DecisionAdAirdropV1ResponseSuccess']> = {
  ad?: Resolver<Maybe<ResolversTypes['AdServed']>, ParentType, ContextType>;
  errorMessage?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  questions?: Resolver<Array<ResolversTypes['AdOfferQuestion']>, ParentType, ContextType>;
  requiresAd?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type DecisionAdApiBetaV2ResponseSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['DecisionAdApiBetaV2ResponseSuccess'] = ResolversParentTypes['DecisionAdApiBetaV2ResponseSuccess']> = {
  ad?: Resolver<Maybe<ResolversTypes['AdServed']>, ParentType, ContextType>;
  questions?: Resolver<Maybe<Array<ResolversTypes['AdOfferQuestion']>>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type DepositVoucherRewardsResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['DepositVoucherRewardsResponse'] = ResolversParentTypes['DepositVoucherRewardsResponse']> = {
  __resolveType: TypeResolveFn<'DepositVoucherRewardsResponseSuccess' | 'ResponseError', ParentType, ContextType>;
};

export type DepositVoucherRewardsResponseSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['DepositVoucherRewardsResponseSuccess'] = ResolversParentTypes['DepositVoucherRewardsResponseSuccess']> = {
  depositID?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type FanListRowForLootboxResolvers<ContextType = any, ParentType extends ResolversParentTypes['FanListRowForLootbox'] = ResolversParentTypes['FanListRowForLootbox']> = {
  avatar?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  claimsCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  expiredClaimsCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
...
export type FansListForLootboxResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['FansListForLootboxResponse'] = ResolversParentTypes['FansListForLootboxResponse']> = {
  __resolveType: TypeResolveFn<'FansListForLootboxResponseSuccess' | 'ResponseError', ParentType, ContextType>;
};

export type FansListForLootboxResponseSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['FansListForLootboxResponseSuccess'] = ResolversParentTypes['FansListForLootboxResponseSuccess']> = {
  fans?: Resolver<Array<ResolversTypes['FanListRowForLootbox']>, ParentType, ContextType>;
  lootboxID?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type GetLootboxDepositsResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['GetLootboxDepositsResponse'] = ResolversParentTypes['GetLootboxDepositsResponse']> = {
  __resolveType: TypeResolveFn<'GetLootboxDepositsResponseSuccess' | 'ResponseError', ParentType, ContextType>;
};

export type GetLootboxDepositsResponseSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['GetLootboxDepositsResponseSuccess'] = ResolversParentTypes['GetLootboxDepositsResponseSuccess']> = {
  deposits?: Resolver<Array<ResolversTypes['LootboxVoucherDeposits']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type GetVoucherOfDepositForFanResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['GetVoucherOfDepositForFanResponse'] = ResolversParentTypes['GetVoucherOfDepositForFanResponse']> = {
  __resolveType: TypeResolveFn<'GetVoucherOfDepositForFanResponseSuccess' | 'ResponseError', ParentType, ContextType>;
};

export type GetVoucherOfDepositForFanResponseSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['GetVoucherOfDepositForFanResponseSuccess'] = ResolversParentTypes['GetVoucherOfDepositForFanResponseSuccess']> = {
  voucher?: Resolver<ResolversTypes['VoucherDeposit'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type InheritedClaimForAdResolvers<ContextType = any, ParentType extends ResolversParentTypes['InheritedClaimForAd'] = ResolversParentTypes['InheritedClaimForAd']> = {
  claimID?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  promoterID?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  referrerID?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  tournamentID?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
...
export type ListAvailableLootboxesForClaimResponseSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['ListAvailableLootboxesForClaimResponseSuccess'] = ResolversParentTypes['ListAvailableLootboxesForClaimResponseSuccess']> = {
  ...
  termsOfService?: Resolver<Array<ResolversTypes['TournamentPrivacyScope']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type LootboxSafetyFeaturesResolvers<ContextType = any, ParentType extends ResolversParentTypes['LootboxSafetyFeatures'] = ResolversParentTypes['LootboxSafetyFeatures']> = {
  isExclusiveLootbox?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  maxTicketsPerUser?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type LootboxTicketResolvers<ContextType = any, ParentType extends ResolversParentTypes['LootboxTicket'] = ResolversParentTypes['LootboxTicket']> = {
  createdAt?: Resolver<ResolversTypes['Timestamp'], ParentType, ContextType>;
  digest?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  isMinted?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  lootboxAddress?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  lootboxID?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  metadataURL?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  mintWhitelistID?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  mintedAt?: Resolver<Maybe<ResolversTypes['Timestamp']>, ParentType, ContextType>;
  minterAddress?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  minterUserID?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  nonce?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
...
export type LootboxVoucherDepositsResolvers<ContextType = any, ParentType extends ResolversParentTypes['LootboxVoucherDeposits'] = ResolversParentTypes['LootboxVoucherDeposits']> = {
  createdAt?: Resolver<ResolversTypes['Timestamp'], ParentType, ContextType>;
  hasReuseableVoucher?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  isRedeemed?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  oneTimeVouchersCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  answerAfterTicketClaimQuestion?: Resolver<ResolversTypes['AfterTicketClaimQuestionResponse'], ParentType, ContextType, RequireFields<MutationAnswerAfterTicketClaimQuestionArgs, 'payload'>>;
  ...
  bulkCreateLootbox?: Resolver<ResolversTypes['BulkCreateLootboxResponse'], ParentType, ContextType, RequireFields<MutationBulkCreateLootboxArgs, 'payload'>>;
  ...
  claimerCSVData?: Resolver<ResolversTypes['ClaimerCSVDataResponse'], ParentType, ContextType, RequireFields<MutationClaimerCsvDataArgs, 'payload'>>;
  ...
  depositVoucherRewards?: Resolver<ResolversTypes['DepositVoucherRewardsResponse'], ParentType, ContextType, RequireFields<MutationDepositVoucherRewardsArgs, 'payload'>>;
  ...
  offerClaimsCSV?: Resolver<ResolversTypes['OfferClaimsCSVResponse'], ParentType, ContextType, RequireFields<MutationOfferClaimsCsvArgs, 'payload'>>;
  offerEventClaimsCSV?: Resolver<ResolversTypes['OfferEventClaimsCSVResponse'], ParentType, ContextType, RequireFields<MutationOfferEventClaimsCsvArgs, 'payload'>>;
...
export type OfferResolvers<ContextType = any, ParentType extends ResolversParentTypes['Offer'] = ResolversParentTypes['Offer']> = {
  ...
  afterTicketClaimMetadata?: Resolver<Maybe<ResolversTypes['OfferAfterTicketClaimMetadata']>, ParentType, ContextType>;
  ...
  strategy?: Resolver<ResolversTypes['OfferStrategyType'], ParentType, ContextType>;
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  visibility?: Resolver<ResolversTypes['OfferVisibility'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OfferActivationsForEventResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfferActivationsForEventResponse'] = ResolversParentTypes['OfferActivationsForEventResponse']> = {
  __resolveType: TypeResolveFn<'OfferActivationsForEventResponseSuccess' | 'ResponseError', ParentType, ContextType>;
};

export type OfferActivationsForEventResponseSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfferActivationsForEventResponseSuccess'] = ResolversParentTypes['OfferActivationsForEventResponseSuccess']> = {
  data?: Resolver<Array<ResolversTypes['OfferActivationsForEventRow']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OfferActivationsForEventRowResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfferActivationsForEventRow'] = ResolversParentTypes['OfferActivationsForEventRow']> = {
  activationDescription?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  activationID?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  activationName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  adEventCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OfferActivationsResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfferActivationsResponse'] = ResolversParentTypes['OfferActivationsResponse']> = {
  __resolveType: TypeResolveFn<'OfferActivationsResponseSuccess' | 'ResponseError', ParentType, ContextType>;
};

export type OfferActivationsResponseSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfferActivationsResponseSuccess'] = ResolversParentTypes['OfferActivationsResponseSuccess']> = {
  data?: Resolver<Array<ResolversTypes['OfferActivationsRow']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OfferActivationsRowResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfferActivationsRow'] = ResolversParentTypes['OfferActivationsRow']> = {
  activationDescription?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  activationID?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  activationName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  adEventCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
...
export type OfferAfterTicketClaimMetadataResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfferAfterTicketClaimMetadata'] = ResolversParentTypes['OfferAfterTicketClaimMetadata']> = {
...
export type OfferClaimsCsvResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfferClaimsCSVResponse'] = ResolversParentTypes['OfferClaimsCSVResponse']> = {
  __resolveType: TypeResolveFn<'OfferClaimsCSVResponseSuccess' | 'ResponseError', ParentType, ContextType>;
};

export type OfferClaimsCsvResponseSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfferClaimsCSVResponseSuccess'] = ResolversParentTypes['OfferClaimsCSVResponseSuccess']> = {
  csvDownloadURL?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OfferEventClaimsCsvResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfferEventClaimsCSVResponse'] = ResolversParentTypes['OfferEventClaimsCSVResponse']> = {
  __resolveType: TypeResolveFn<'OfferEventClaimsCSVResponseSuccess' | 'ResponseError', ParentType, ContextType>;
};

export type OfferEventClaimsCsvResponseSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfferEventClaimsCSVResponseSuccess'] = ResolversParentTypes['OfferEventClaimsCSVResponseSuccess']> = {
  csvDownloadURL?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  getLootboxDeposits?: Resolver<ResolversTypes['GetLootboxDepositsResponse'], ParentType, ContextType, RequireFields<QueryGetLootboxDepositsArgs, 'lootboxID'>>;
  getMyProfile?: Resolver<ResolversTypes['GetMyProfileResponse'], ParentType, ContextType>;
  getVoucherOfDepositForFan?: Resolver<ResolversTypes['GetVoucherOfDepositForFanResponse'], ParentType, ContextType, RequireFields<QueryGetVoucherOfDepositForFanArgs, 'payload'>>;
  ...
  offerActivations?: Resolver<ResolversTypes['OfferActivationsResponse'], ParentType, ContextType, RequireFields<QueryOfferActivationsArgs, 'payload'>>;
  offerActivationsForEvent?: Resolver<ResolversTypes['OfferActivationsForEventResponse'], ParentType, ContextType, RequireFields<QueryOfferActivationsForEventArgs, 'payload'>>;
...
export type TournamentResolvers<ContextType = any, ParentType extends ResolversParentTypes['Tournament'] = ResolversParentTypes['Tournament']> = {
  ...
  playbookUrl?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  privacyScope?: Resolver<Maybe<Array<ResolversTypes['TournamentPrivacyScope']>>, ParentType, ContextType>;
  prize?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  ...
  visibility?: Resolver<ResolversTypes['TournamentVisibility'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type TournamentSafetyFeaturesResolvers<ContextType = any, ParentType extends ResolversParentTypes['TournamentSafetyFeatures'] = ResolversParentTypes['TournamentSafetyFeatures']> = {
  maxTicketsPerUser?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  seedMaxLootboxTicketsPerUser?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type VoucherDepositResolvers<ContextType = any, ParentType extends ResolversParentTypes['VoucherDeposit'] = ResolversParentTypes['VoucherDeposit']> = {
...
export type Resolvers<ContextType = any> = {
  ...
  AdOfferQuestion?: AdOfferQuestionResolvers<ContextType>;
  ...
  AfterTicketClaimQuestionResponse?: AfterTicketClaimQuestionResponseResolvers<ContextType>;
  AfterTicketClaimQuestionResponseSuccess?: AfterTicketClaimQuestionResponseSuccessResolvers<ContextType>;
  ...
  BulkCreateLootboxResponse?: BulkCreateLootboxResponseResolvers<ContextType>;
  BulkCreateLootboxResponseSuccess?: BulkCreateLootboxResponseSuccessResolvers<ContextType>;
  ...
  BulkLootboxCreatedPartialError?: BulkLootboxCreatedPartialErrorResolvers<ContextType>;
  ...
  ClaimerCSVDataResponse?: ClaimerCsvDataResponseResolvers<ContextType>;
  ClaimerCSVDataResponseSuccess?: ClaimerCsvDataResponseSuccessResolvers<ContextType>;
  ...
  DecisionAdAirdropV1Response?: DecisionAdAirdropV1ResponseResolvers<ContextType>;
  DecisionAdAirdropV1ResponseSuccess?: DecisionAdAirdropV1ResponseSuccessResolvers<ContextType>;
  ...
  DepositVoucherRewardsResponse?: DepositVoucherRewardsResponseResolvers<ContextType>;
  DepositVoucherRewardsResponseSuccess?: DepositVoucherRewardsResponseSuccessResolvers<ContextType>;
  ...
  FansListForLootboxResponse?: FansListForLootboxResponseResolvers<ContextType>;
  FansListForLootboxResponseSuccess?: FansListForLootboxResponseSuccessResolvers<ContextType>;
  ...
  GetLootboxDepositsResponse?: GetLootboxDepositsResponseResolvers<ContextType>;
  GetLootboxDepositsResponseSuccess?: GetLootboxDepositsResponseSuccessResolvers<ContextType>;
  ...
  GetVoucherOfDepositForFanResponse?: GetVoucherOfDepositForFanResponseResolvers<ContextType>;
  GetVoucherOfDepositForFanResponseSuccess?: GetVoucherOfDepositForFanResponseSuccessResolvers<ContextType>;
  ...
  InheritedClaimForAd?: InheritedClaimForAdResolvers<ContextType>;
  ...
  LootboxSafetyFeatures?: LootboxSafetyFeaturesResolvers<ContextType>;
  ...
  LootboxVoucherDeposits?: LootboxVoucherDepositsResolvers<ContextType>;
  ...
  OfferActivationsForEventResponse?: OfferActivationsForEventResponseResolvers<ContextType>;
  OfferActivationsForEventResponseSuccess?: OfferActivationsForEventResponseSuccessResolvers<ContextType>;
  OfferActivationsForEventRow?: OfferActivationsForEventRowResolvers<ContextType>;
  OfferActivationsResponse?: OfferActivationsResponseResolvers<ContextType>;
  OfferActivationsResponseSuccess?: OfferActivationsResponseSuccessResolvers<ContextType>;
  OfferActivationsRow?: OfferActivationsRowResolvers<ContextType>;
  OfferAffiliateView?: OfferAffiliateViewResolvers<ContextType>;
  OfferAfterTicketClaimMetadata?: OfferAfterTicketClaimMetadataResolvers<ContextType>;
  ...
  OfferClaimsCSVResponse?: OfferClaimsCsvResponseResolvers<ContextType>;
  OfferClaimsCSVResponseSuccess?: OfferClaimsCsvResponseSuccessResolvers<ContextType>;
  OfferEventClaimsCSVResponse?: OfferEventClaimsCsvResponseResolvers<ContextType>;
  OfferEventClaimsCSVResponseSuccess?: OfferEventClaimsCsvResponseSuccessResolvers<ContextType>;
  ...
  TournamentSafetyFeatures?: TournamentSafetyFeaturesResolvers<ContextType>;
  ...
  VoucherDeposit?: VoucherDepositResolvers<ContextType>;
